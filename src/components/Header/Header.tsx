        ...
        <header className={style.header}>
            <nav className={style.nav}>
                ...
                <div className={style.tools}>
                    ...
                    <div
                        className={`${style.tools_box} ${style.tools__analytics}`}
                    >
                        <img src={analytics} alt="analytics icon" />
                        <span>Analytics</span>
                    </div>
                    <div
                        className={`${style.tools_box} ${style.tools__revenue}`}
                    >
                        ...
                        >
                            ...
                            <div className={style.tools__apps_dropdown}>
                                <div className={style.tools__apps_dropdown_box}>
                                    <div
                                        className={
                                            style.tools__apps_dropdown_img
                                        }
                                    >
                                    ...
                                    <div
                                        className={
                                            style.tools__apps_dropdown_text
                                        }
                                    >
                                        <h3>Link in Bio</h3>
                ...
                >
                    ...
                    {settingsToggle && (
                        <div className={style.settings__dropdown}>
                            ...
                            >
                                <span className={style.menu__group_text}>
                                    OJ
                                </span>
